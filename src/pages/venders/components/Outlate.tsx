  ...
  mutation VendorOutletStatusUpdation($input: VendorOutletStatusUpdationInput!) {
  ...
  `;
      ...
      mutation VendorCompanyStatusUpdation($input: VendorCompanyStatusUpdationInput!) {
...
{outletData && (
  ...
  <span
    onClick={() => handleImageClick(outletData?.exteriorImage?.fileURL)}
    style={{
      cursor: "pointer",
  ...
  <span
    onClick={() => handleImageClick(outletData?.interiorImage?.fileURL)}
    style={{
      cursor: "pointer",
      border: "1px solid #ccc",
      padding: "8px",
  ...
  <span
    style={{
      ...
      padding: "5px 10px",
      borderRadius: "15px",
      background: getStatusColor(outletData?.status), // You can define a function to determine the color based on status
                    ...
                    <CardText>
                      ...
                      <div className="truncate-text mt-5" >
                        {companyData?.cooCertificate && (
                              <div style={{ display: "flex", alignItems: "center" }}>
                              <span
                                onClick={() => handleImageClick(companyData?.cooCertificate?.fileURL)}
                                style={{
                                  cursor: "pointer",
                                  border: "1px solid #ccc",
                                  padding: "8px",
                      ...
                      {companyData && (
                        <CardText>
                          <strong>Remarks:</strong>
                          <ul>
                            {companyData?.remarks.map((remark: any, index: any) => (
                              <li key={index}>{remark}</li>
                            ))}
                          </ul>
                        </CardText>
  ...
  <span
    style={{
      ...
      padding: "5px 10px",
      borderRadius: "15px",
      background: getStatusColor(companyData?.status), // You can define a function to determine the color based on status
      color: "#fff", // Adjust text color as needed
      marginLeft: "10px", // Adjust spacing
    }}
  >
