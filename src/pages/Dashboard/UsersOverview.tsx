...
function UsersOverview() {
    ...
    query GetDashboardlUsersSummary {
    getDashboardlUsersSummary {
    totalUsers
    activeUsers
    blockedUsers
    todayUsers
    ...
    useEffect(() => {
        if (usersCountsData && usersCountsData?.getDashboardlUsersSummary) {
            setUsersCounts(usersCountsData?.getDashboardlUsersSummary)
        }
