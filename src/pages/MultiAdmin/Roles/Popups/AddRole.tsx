...
const CREATE_ROLE = gql`
  mutation CreateRoleBySuperAdmin($input: createRoleBySuperAdminInput!) {
    createRoleBySuperAdmin(input: $input) {
      success
      message
    }
  }
...
const AddRole = ({ isOpen, toggle, refetch }: any) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (response?.data?.createRoleBySuperAdmin?.success) {
        console.log(response?.data?.createRoleBySuperAdmin?.message);
        toast.success(response?.data?.createRoleBySuperAdmin?.message);
        toggle();
        refetch();
        resetForm();
      } else {
        toast.error(response?.data?.createRoleBySuperAdmin?.message);
      }
    } catch (error: any) {
